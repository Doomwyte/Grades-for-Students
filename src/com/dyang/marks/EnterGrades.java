...
public class EnterGrades extends SherlockActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView gradesContentLabelText = (TextView) gradesContentLabel
                .getChildAt(0);
        ...
        CourseAdapter cAdapter = new CourseAdapter(this,
                android.R.layout.simple_spinner_item, allCourses);
        ...
        courseSpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                    int arg2, long arg3) {
                CourseObj selectedCourse = ((CourseObj) courseSpinner
                        .getSelectedItem());
                    ...
                    if (gradesLayout.getVisibility() != View.INVISIBLE) {
                        categorySpinner.startAnimation(AnimationUtils
                                .loadAnimation(getApplicationContext(),
                                        R.anim.fadeout));
                        gradesLayout.startAnimation(AnimationUtils
                                .loadAnimation(getApplicationContext(),
                                        R.anim.fadeout));
                ...
                CategoryAdapter caAdapter = new CategoryAdapter(
                        EnterGrades.this, android.R.layout.simple_spinner_item,
                        db.getAllCategories(selectedCourse.getId()));
                caAdapter
                        .setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
                categorySpinner.setAdapter(caAdapter);
                categorySpinner.startAnimation(AnimationUtils.loadAnimation(
                        getApplicationContext(), R.anim.fadein));
                gradesLayout.startAnimation(AnimationUtils.loadAnimation(
                        getApplicationContext(), R.anim.fadein));
                categorySpinner.setVisibility(View.VISIBLE);
                gradesLayout.setVisibility(View.VISIBLE);
                selectedCourseId = ((CourseObj) courseSpinner.getSelectedItem())
                        .getId();
            }
        ...
        categorySpinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                selectedCategoryId = ((CategoryObj) categorySpinner
    ...
    public void rowManager(boolean newCategory, boolean addMore) {
        ...
        gradesRow = (LinearLayout) LayoutInflater.from(getBaseContext())
        ...
        List<GradeObj> results = retrieveGrades(
                ((CourseObj) courseSpinner.getSelectedItem()).getId(),
        ...
        if (results.size() > 0 && !addMore) {
            ...
            for (int i = 0; i < results.size(); i++) {
                ...
                gradesRowDelete.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View arg0) {
                        final LinearLayout row = (LinearLayout) ((ImageView) arg0)
                                .getParent();
                ...
                gradesContent.addView(gradesRow,
                        gradesContent.getChildCount() - 1);
                counter++;

                gradesRow = (LinearLayout) LayoutInflater
                        .from(getBaseContext()).inflate(R.layout.grades_row,
                                null);
            }
        } else {
            child.setText(((CategoryObj) categorySpinner.getSelectedItem())
        ...
        gradesContentScroll.post(new Runnable() {
            public void run() {
                ...
                ((LinearLayout) gradesContent.getChildAt(gradesContent
                        .getChildCount() - 2)).getChildAt(1).requestFocus();
            }
        });
    ...
    public void editCourse(View clicked) {
        ...
        editCourse.setPadding(15, 0, 0, 0);
        ...
        courseWeighting.setPadding(15, 0, 0, 0);
        ...
        LinearLayout.LayoutParams linearLp = new LinearLayout.LayoutParams(0,
    ...
    public void insertGrades() {
        if (courseSpinner.getSelectedItem() == null || courseSpinner == null
        ...
        for (int i = 0; i < gradesContent.getChildCount() - 1; i++) {
            ...
            if (!grade.getText().toString().trim().equals("")) {
                db.addGrade(new GradeObj(db.getNextGradeId(), grade_name
                        .getText().toString(), Double.valueOf(grade.getText()
                        .toString()), selectedCourseId, selectedCategoryId));
            }
        }
        db.close();
    }
